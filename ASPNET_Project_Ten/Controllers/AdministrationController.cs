...
namespace ASPNET_Project_Eleven.Controllers
{
    ...
    [Authorize(Policy = "ExecutiveLevelPolicy")]
    ...
    public class AdministrationController : Controller
    {
        ...
        [HttpGet]
     // [Authorize(Policy = "EditRoleDifferentPolicy")]
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            Logger.WriteLog(DateTime.Now.ToString() + $" Accessing ManageUserClaims Page for {user.Email}");
            return View(model);
        }
     ...
     // [Authorize(Policy = "EditRoleDifferentPolicy")]
        public async Task<IActionResult> ManageUserClaims(UserClaimViewModel model)
        {
            ...
            Logger.WriteLog(DateTime.Now.ToString() + $" Posting ManageUserClaims changes for {user.Email}");
            foreach (var claim in await userManager.GetClaimsAsync(user))
            {
                Logger.WriteLog(DateTime.Now.ToString() + $" {user.Email} has claim {claim.Type} as {claim.Value}");
            }
